...
<body>
        ...
        <h3 style="text-align: center;">Invoice Date : {{ $sale->date }}</h3>
        <h4 style="text-align: center;">Customer Name : {{ $sale->customers->cu_name }}</h4>
        <h4 style="text-align: center;">Invoice Created By : {{ $sale->users->name }} </h4>
