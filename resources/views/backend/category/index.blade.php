	...
	<div class="col-md-8 col-md-offset-2">
		<div class="panel">
			...
			<header class="panel-heading">
					<a href="{{ URL::route('category.create') }}" class="btn btn-main-inv">Create Category</a>
			</header>
					...
					<tbody>
						@foreach($parents as $m)
							<tr>
								<td>{{ $m->name }}</td>
								<td>
									<a href="{{ URL::route('category.edit', $m->id) }}" class="btn btn-xs btn-info"><i class="fa fa-edit"></i>Edit</a>
