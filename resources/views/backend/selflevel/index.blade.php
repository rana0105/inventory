	...
	<div class="col-md-8 col-md-offset-2">
		<div class="panel">
			...
			<header class="panel-heading">
					<a href="{{ URL::route('shelfs.create') }}" class="btn btn-main-inv">Create Shelf</a>
			</header>
					...
					<tbody>
						@foreach($shelfs as $m)
							<tr>
								<td>{{ $m->number }}</td>
								<td>
									<a href="{{ URL::route('shelfs.edit', $m->id) }}" class="btn btn-xs btn-info"><i class="fa fa-edit"></i>Edit</a>
