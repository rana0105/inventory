          ...
          <div class="row main">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group {{ $errors->has('cu_name') ? ' has-error' : '' }}">
                        ...
                        <div class="cols-sm-10">
                            <input type="text" name="cu_name" id="cu_name" class="form-control"  value="{{ $customer->cu_name }}"/>
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group {{ $errors->has('cu_phone') ? ' has-error' : '' }}">
                        ...
                        <div class="cols-sm-10">
                            <input type="text" name="cu_phone" id="cu_phone" class="form-control"  value="{{ $customer->cu_phone }}"/>
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group {{ $errors->has('cu_email') ? ' has-error' : '' }}">
                        ...
                        <div class="cols-sm-10">
                            <input type="email" name="cu_email" id="cu_email" class="form-control" value="{{ $customer->cu_email }}"/>
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group {{ $errors->has('cu_address') ? ' has-error' : '' }}">
                        ...
                        <div class="cols-sm-10">
                            <textarea name="cu_address" id="cu_address" class="form-control height-t"  value="{{ $customer->cu_address }}">{{ $customer->cu_address }}</textarea>
